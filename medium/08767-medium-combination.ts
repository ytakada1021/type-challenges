...
type Permutation<R extends unknown[], L extends unknown[] = []> = R extends [
  infer First,
  ...infer Rest
]
  ?
      | [First | "", ...Permutation<[...Rest, ...L]>]
      | (Rest["length"] extends 0 ? never : Permutation<Rest, [...L, First]>)
  : [];
...
type Combination<T extends string[]> = Exclude<Join<Permutation<T>>, "">;
