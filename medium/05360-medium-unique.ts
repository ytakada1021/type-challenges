...
type Unique<T extends unknown[], Result extends unknown[] = []> = T extends [infer F, ...infer R]
...
// better solution
// type Unique<T extends unknown[]> = T extends [...infer F, infer R]
//   ? Includes<F, R> extends true
//     ? Unique<F>
//     : [...Unique<F>, R]
//   : [];
