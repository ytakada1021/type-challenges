...
type Unbox<T, N extends number = never, Counter extends unknown[] = []> = 0 extends N
  ? Unbox<T>
  : Counter["length"] extends N
  ? T
  : T extends (infer P)[]
  ? Unbox<P, N, [...Counter, unknown]>
  : T extends (...args: unknown[]) => infer Q
  ? Unbox<Q, N, [...Counter, unknown]>
  : T extends Promise<infer R>
  ? Unbox<R, N, [...Counter, unknown]>
  : T;

// better solution in issues
// type Unbox<T, N extends number = 0, Counter extends unknown[] = [unknown]> = T extends
//   | (infer P)[]
//   | ((...args: unknown[]) => infer P)
//   | Promise<infer P>
