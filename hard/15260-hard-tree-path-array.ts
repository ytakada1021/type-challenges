...
type Path<T, U extends keyof T = keyof T> = T extends object ? (U extends U ? [U] | [U, ...Path<T[U]>] : never) : never;

/* _____________ Test Cases _____________ */
import type { ExpectExtends, ExpectFalse, ExpectTrue } from "../util-types";
