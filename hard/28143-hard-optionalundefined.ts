...
type OptionalUndefined<
  ...
  U = {
    [P in keyof T as undefined extends T[P] ? (P extends Props ? P : never) : never]?: T[P];
  }
> = Omit<U & Omit<T, keyof U>, never>;
...
type cases = [
  ...
  Expect<
    Equal<OptionalUndefined<{ value: string | undefined; desc: string }, "value">, { value?: string; desc: string }>
  >,
  Expect<
    Equal<
  ...
  >,
  Expect<
    Equal<OptionalUndefined<{ value: string | undefined; desc: string | undefined }>, { value?: string; desc?: string }>
  >,
